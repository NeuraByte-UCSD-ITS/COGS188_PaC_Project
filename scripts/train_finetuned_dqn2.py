...
class DeepQNetwork(tf.keras.Model):
    def __init__(self, action_space_size):
        ...
        self.first_hidden_layer = layers.Dense(512, activation='relu')  #Increased hidden layer size for fine tuning iteration 2
        self.second_hidden_layer = layers.Dense(512, activation='relu') # Increased hidden layer size for fine tuning iteration 2
...
#increased replay buffer size, batch size, and decreased learning rate for fine tuning iteration 2
class DeepQNetworkAgent:
    def __init__(self, state_shape, action_space_size, replay_buffer_size=50000, batch_size=256, discount_factor=0.99, learning_rate=0.0001, exploration_rate=1.0, exploration_decay=0.995, exploration_min=0.01):
...
def train_deep_q_network():
    ...
    number_of_episodes = 1500  #increased number of episodes for fine tuning iteration 2
